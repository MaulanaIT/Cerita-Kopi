                    ...
                    @foreach ($data_bahan_baku as $data)
                        <tr>
                            ...
                            <td class="text-center text-nowrap">
                                ...
                                <button id="ubah-{{$data->kode}}" class="btn btn-warning px-3" onclick="ubahData('{{$data->kode}}')"><i class="fas fa-edit"></i>&ensp;Ubah</button>
                                <button id="hapus-{{$data->kode}}" class="btn btn-danger px-3" onclick="hapusData('{{$data->kode}}')"><i class="fas fa-trash"></i>&ensp;Hapus</button>
                            </td>
                        </tr>
                    @endforeach
                @endif
